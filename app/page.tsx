  ...
  return (
    <AppShell textured>
      <section className="relative pb-7 pt-5">
        ...
        <h1 className="relative max-w-[320px] text-[3rem] font-semibold leading-[1.12] tracking-normal text-white">
          您的名字，<br />在拖您的后腿吗？
        </h1>
        <p className="mt-5 text-[17px] leading-8 text-warmGray">
          AI 结合传统姓名学、生肖喜忌与紫微命盘方向，30 秒测算您的名、情、财运势，先看名字是助力，还是隐形阻力。
        </p>
      </section>
